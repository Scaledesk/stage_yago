...
;(function ($, window) {
  ...
  (function (p) {
      ...
      p.moveTabContentOutsideScrollContainer = function (options) {
        var ehd = this,
            ...
            tabContentCloneCssClass = 'scrtabs-tab-content2-clone',
            tabContentHiddenCssClass = 'scrtabs-tab-content2-hidden',
            $tabContent = $tabsContainer.find('.tab-content2').not('.' + tabContentCloneCssClass),
            $currTcClone,
            $newTcClone;
      ...
      p.setElementReferences = function () {
        ...
        stc.$fixedContainer = $tabsContainer.find('.scrtabs-tabs-fixed-container1');
        stc.$movableContainer = $tabsContainer.find('.scrtabs-tabs-movable-container1');
        stc.$tabsUl = $tabsContainer.find('.nav-tabs2');
        ...
        stc.$leftScrollArrow = $tabsContainer.find('.scrtabs-js-tab-scroll-arrow-left1');
        stc.$rightScrollArrow = $tabsContainer.find('.scrtabs-js-tab-scroll-arrow-right1');
  ...
  var tabElements = (function () {
    ...
    function getNewElNavTabs() {
      return $('<ul class="nav nav-tabs2" role="tablist"></ul>');
    }

    function getNewElScrollerElementWrappingNavTabsInstance($navTabsInstance) {
      var $tabsContainer = $('<div class="scrtabs-tab-container1"></div>'),
          $leftArrow = $('<div class="scrtabs-tab-scroll-arrow1 scrtabs-js-tab-scroll-arrow-left1"><span class="glyphicon glyphicon-chevron-left"></span></div>'),
          $rightArrow = $('<div class="scrtabs-tab-scroll-arrow1 scrtabs-js-tab-scroll-arrow-right1"><span class="glyphicon glyphicon-chevron-right"></span></div>'),
          $fixedContainer = $('<div class="scrtabs-tabs-fixed-container1"></div>'),
          $movableContainer = $('<div class="scrtabs-tabs-movable-container1"></div>');
    ...
    function getNewElTabContent() {
      return $('<div class="tab-content2"></div>');
    }
  ...
  function buildNavTabsAndTabContentForTargetElementInstance($targetElInstance, settings) {
    ...
    $scroller.find('.nav-tabs2 > li').each(function (index) {
  ...
  function destroyPlugin() {
    ...
    if (scrtabsData.isWrapperOnly) { // we just wrapped nav-tabs markup, so restore it
      ...
      $tabsContainer = $targetElInstance.parents('.scrtabs-tab-container1');
  ...
  function refreshTargetElementInstance($container, options) {
    var instanceData = $container.data().scrtabs,
        ...
        $navTabs = $container.find('.scrtabs-tab-container1 .nav-tabs2'),
        $currTabContentPanesContainer = $container.find('.tab-content2'),
        isInitTabsRequired = false,
        refreshData = {
          options: options,
