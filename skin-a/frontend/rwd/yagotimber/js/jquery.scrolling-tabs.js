...
;(function ($, window) {
  ...
  (function (p) {
      ...
      p.moveTabContentOutsideScrollContainer = function (options) {
        var ehd = this,
            ...
            tabContentCloneCssClass = 'scrtabs-tab-content1-clone',
            tabContentHiddenCssClass = 'scrtabs-tab-content1-hidden',
            $tabContent = $tabsContainer.find('.tab-content1').not('.' + tabContentCloneCssClass),
            $currTcClone,
            $newTcClone;
      ...
      p.setElementReferences = function () {
        ...
        stc.$tabsUl = $tabsContainer.find('.nav-tabs1');
  ...
  var tabElements = (function () {
    ...
    function getNewElNavTabs() {
      return $('<ul class="nav nav-tabs1" role="tablist"></ul>');
    }
    ...
    function getNewElTabContent() {
      return $('<div class="tab-content1"></div>');
    }
  ...
  function buildNavTabsAndTabContentForTargetElementInstance($targetElInstance, settings) {
    ...
    $scroller.find('.nav-tabs1 > li').each(function (index) {
  ...
  function refreshTargetElementInstance($container, options) {
    var instanceData = $container.data().scrtabs,
        ...
        $navTabs = $container.find('.scrtabs-tab-container .nav-tabs1'),
        $currTabContentPanesContainer = $container.find('.tab-content1'),
        isInitTabsRequired = false,
        refreshData = {
          options: options,
